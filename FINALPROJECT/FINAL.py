...
if option == titleList[0]:
    st.image(openImage('StreamlitApp//FINALPROJECT//skyscrapers.jpg'), caption='Source: Romain Trystram')
...
# CHAPTER 2 THE OPENING OF CHINA
    ...
    st.image(openImage('StreamlitApp//FINALPROJECT//Flag-China.jpg'), caption='Source: Encyclopedia Britannica')
    ...
    st.image(openImage('StreamlitApp//FINALPROJECT//russiamap.jpg'), caption='Source: Encyclopedia Britannica')
